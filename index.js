...
requestEndPoint("json_data/latest_meals.json",4,"strCategoryThumb","strCategory","popular-row",generateHtml);
requestEndPoint("json_data/latest_meals.json",8,"strMealThumb","strMeal","random-row",generateHtml);
requestEndPoint("json_data/latest_meals.json",4,"strCategoryThumb","strCategory","ingredient-row",generateHtml);
